...
@Entity
@Table(name = "ric_condicionprediotipo", schema = "public")
public class Ric_condicionprediotipo {
    @Id()
    ...
    @OneToMany(mappedBy = "ric_condicionprediotipo", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonIgnore
    private Set<Ric_predio> ricpredio;

    public Ric_condicionprediotipo(Integer t_id, String thisclass, String baseclass, Integer itfcode, String ilicode, Integer seq, Boolean inactive, String dispname, String description) {
        this.t_id = t_id;
    ...
    public Ric_condicionprediotipo() {
    }
