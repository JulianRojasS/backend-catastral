...
@Entity
@Table(name = "col_estadoredserviciostipo", schema = "public")
public class Col_estadoredserviciostipo {
    @Id
    ...
    @OneToMany(mappedBy = "col_estadoredserviciostipo", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonIgnore
    private Set<Ric_nu_espaciojuridicoredservicios> ricnuespaciojuridicoredservicios;

    public Col_estadoredserviciostipo(Integer t_id, String thisclass, String baseclass, Integer itfcode, String ilicode, Integer seq, Boolean inactive, String dispname, String description) {
        this.t_id = t_id;
    ...
    public Col_estadoredserviciostipo() {
    }
