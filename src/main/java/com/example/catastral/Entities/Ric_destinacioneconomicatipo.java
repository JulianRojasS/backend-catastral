...
@Entity
@Table(name = "ric_destinacioneconomicatipo", schema = "public")
public class Ric_destinacioneconomicatipo {
    @Id
    ...
    @OneToMany(mappedBy = "ric_destinacioneconomicatipo", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonIgnore
    private Set<Ric_predio> ricpredio;

    public Ric_destinacioneconomicatipo(Integer t_id, String thisclass, String baseclass, Integer itfcode, String ilicode, Integer seq, Boolean inactive, String dispname, String description) {
        this.t_id = t_id;
    ...
    public Ric_destinacioneconomicatipo() {
    }
