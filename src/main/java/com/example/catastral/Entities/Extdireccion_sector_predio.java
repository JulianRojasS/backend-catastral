...
@Entity
@Table(name = "extdireccion_sector_predio", schema = "public")
public class Extdireccion_sector_predio {
    @Id
    ...
    @OneToMany(mappedBy = "extdireccion_sector_predio", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonIgnore
    private Set<Extdireccion> extdireccion;

    public Extdireccion_sector_predio(Integer t_id, String thisclass, String baseclass, Integer itfcode, String ilicode, Integer seq, Boolean inactive, String dispname, String description) {
        this.t_id = t_id;
    ...
    public Extdireccion_sector_predio() {
    }
