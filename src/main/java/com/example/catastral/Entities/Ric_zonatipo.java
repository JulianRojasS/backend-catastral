...
@Entity
@Table(name = "ric_zonatipo", schema = "public")
public class Ric_zonatipo {
    @Id
    ...
    @OneToMany(mappedBy = "ric_zonatipo", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonIgnore
    private Set<Ric_predio> ricpredio;

    public Ric_zonatipo(Integer t_id, String thisclass, String baseclass, Integer itfcode, String ilicode, Integer seq, Boolean inactive, String dispname, String description) {
        this.t_id = t_id;
