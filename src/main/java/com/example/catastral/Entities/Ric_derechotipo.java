...
@Entity
@Table(name = "ric_derechotipo", schema = "public")
public class Ric_derechotipo {
    @Id
    ...
    @OneToMany(mappedBy = "ric_derechotipo", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonIgnore
    private Set<Ric_derecho> ricderecho;

    public Ric_derechotipo(Integer t_id, String thisclass, String baseclass, Integer itfcode, String ilicode, Integer seq, Boolean inactive, String dispname, String description) {
        this.t_id = t_id;
