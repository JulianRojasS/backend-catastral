...
@Entity
@Table(name = "extdireccion_tipo_direccion", schema = "public")
public class Extdireccion_tipo_direccion {
    @Id
    ...
    @OneToMany(mappedBy = "extdireccion_tipo_direccion", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonIgnore
    private Set<Extdireccion> extdireccion;

    public Extdireccion_tipo_direccion(Integer t_id, String thisclass, String baseclass, Integer itfcode, String ilicode, Integer seq, Boolean inactive, String dispname, String description) {
        this.t_id = t_id;
    ...
    public Extdireccion_tipo_direccion() {
    }
