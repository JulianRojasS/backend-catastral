...
@Entity
@Table(name = "ric_catastrotipo", schema = "public")
public class Ric_catastrotipo {
    @Id
    ...
    @OneToMany(mappedBy = "ric_catastrotipo", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonIgnore
    private Set<Ric_predio> ricpredio;

    public Ric_catastrotipo(Integer t_id, String thisclass, String baseclass, Integer itfcode, String ilicode, Integer seq, Boolean inactive, String dispname, String description) {
        this.t_id = t_id;
