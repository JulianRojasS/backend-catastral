...
@Entity
@Table(name = "col_relacionsuperficietipo", schema = "public")
public class Col_relacionsuperficietipo {
    ...
    public Col_relacionsuperficietipo() {
    }
    ...
    public Set<Ric_nu_espaciojuridicounidadedificacion> getRicnuespaciojuridicounidadedificacions() {
        return ricnuespaciojuridicounidadedificacions;
    }

    public void setRicnuespaciojuridicounidadedificacions(Set<Ric_nu_espaciojuridicounidadedificacion> ricnuespaciojuridicounidadedificacions) {
        this.ricnuespaciojuridicounidadedificacions = ricnuespaciojuridicounidadedificacions;
    }
