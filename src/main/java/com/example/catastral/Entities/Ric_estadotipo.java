...
@Entity
@Table(name = "ric_estadotipo", schema = "public")
public class Ric_estadotipo {
    @Id
    ...
    @OneToMany(mappedBy = "ric_estadotipo", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonIgnore
    private Set<Ric_predio> ricpredio;

    public Ric_estadotipo(Integer t_id, String thisclass, String baseclass, Integer itfcode, String ilicode, Integer seq, Boolean inactive, String dispname, String description) {
        this.t_id = t_id;
