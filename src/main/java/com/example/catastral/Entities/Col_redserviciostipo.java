...
@Entity
@Table(name = "col_redserviciostipo", schema = "public")
public class Col_redserviciostipo {
    @Id
    ...
    @OneToMany(mappedBy = "col_redserviciostipo", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JsonIgnore
    private Set<Ric_nu_espaciojuridicoredservicios> ricnuespaciojuridicoredservicios;

    public Col_redserviciostipo(Integer t_id, String thisclass, String baseclass, Integer itfcode, String ilicode, Integer seq, Boolean inactive, String dispname, String description) {
        this.t_id = t_id;
