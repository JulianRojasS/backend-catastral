...
public interface ric_derechoRepository extends CrudRepository<Ric_derecho, Integer> {
    @Modifying
    @Transactional
    @Query(value = "update ric.ric_derecho set tipo = :tipo, fraccion_derecho = :fraccion, fecha_inicio_tenencia = :fit, descripcion = :descipcion ,interesado_ric_interesado = :interesado, interesado_ric_agrupacioninteresados = :agrupacion where t_id = :derecho", nativeQuery = true)
